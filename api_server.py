...
async def get_txs(request: TXSRequest):
    ...
    use_aptos = request.use_aptos

    if use_aptos:
        explorer_bls_url = warp_explorer_url(wallet_address, explorer_api_key=explorer_api_key, use_aptos=True,
                                           action="balance")
        explorer_txs_url = warp_explorer_url(wallet_address, explorer_api_key=explorer_api_key, use_aptos=True,
                                           action="txlist")
    else:
        explorer_bls_url = warp_explorer_url(wallet_address, explorer_api_key=explorer_api_key, chain_id=chain_id, 
                                           use_aptos=False, action="balance")
        explorer_txs_url = warp_explorer_url(wallet_address, explorer_api_key=explorer_api_key, chain_id=chain_id, 
                                           use_aptos=False, action="txlist")

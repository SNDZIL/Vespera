  ...
  return connected ? (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button className="lg:text-lg cursor-pointer">
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      <DialogTrigger asChild>
        <Button className="bg-blue-400 hover:bg-blue-500 px-8 py-3 lg:text-lg font-semibold uppercase rounded text-white cursor-pointer">
          Connect a Wallet
        </Button>
      </DialogTrigger>
...
function ConnectWalletDialog({ close }: ConnectWalletDialogProps) {
  ...
  const isPublicMintPage = pathname !== "/merchant" && pathname !== "/";
